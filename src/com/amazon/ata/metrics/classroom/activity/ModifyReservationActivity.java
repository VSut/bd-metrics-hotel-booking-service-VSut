...
public class ModifyReservationActivity {
    ...
    public UpdatedReservation handleRequest(final String reservationId, final ZonedDateTime checkInDate,
        ...
        metricsPublisher.addMetric(MetricsConstants.RESERVATION_REVENUE, updatedReservation.getModifiedReservation().getTotalCost().subtract(updatedReservation.getOriginalReservation().getTotalCost()).doubleValue(), StandardUnit.None);
